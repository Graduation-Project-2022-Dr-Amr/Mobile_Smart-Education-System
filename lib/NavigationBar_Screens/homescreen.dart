...
import 'package:smartEdu/Screens/course_screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                child: Column(children: List.generate(5, (index) => buildarticalitem(context, index))),
              ),
            ],
          ),
        ),
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                    top: SizeConfig.getProportionateScreenWidth(11), bottom: SizeConfig.getProportionateScreenWidth(4)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(
