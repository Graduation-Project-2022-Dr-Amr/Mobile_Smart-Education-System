...
import 'package:smartEdu/data/Models/course.dart';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        "https://mohamedameer.pythonanywhere.com/api/${allCourses[index].thumbnail}"), //AssetImage('${coursesData[index]['imageURL']}'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
