...
import 'package:smartEdu/Screens/articale_screen.dart';
import 'package:smartEdu/data/Models/chapter.dart';
...
class CourseScreen extends StatefulWidget {
  ...
  const CourseScreen({Key? key, required this.courseData}) : super(key: key);
...
class _CourseScreenState extends State<CourseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (context) => CourseBloc()..getAllVideos(courseId: widget.courseData.id),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              widget.courseData.teacher != null || true ? coursesData[0]['doctorName'] : "",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
