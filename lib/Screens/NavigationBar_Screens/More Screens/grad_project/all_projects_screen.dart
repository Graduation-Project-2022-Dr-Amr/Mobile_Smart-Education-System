...
import 'package:smart_education/Screens/NavigationBar_Screens/More%20Screens/grad_project/project_details_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (innerContext, index) {
          return InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (_) => ProjectDetailsScreen()));
            },
            child: Card(
