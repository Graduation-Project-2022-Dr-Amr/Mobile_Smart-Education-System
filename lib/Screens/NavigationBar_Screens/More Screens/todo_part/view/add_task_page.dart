              ...
              child: Column(
                children: [
                  ...
                  TimeBox(
                      ...
                      hint: intl.DateFormat.yMMMMEEEEd(/*AppLocalizations.of(context)!.language*/)
                    ...
                    children: [
                      Expanded(
                        child: TimeBox(
                            ...
                            onPressed: () {
                              FocusScope.of(context).unfocus();
                              todoProviderForMethods.getTimeFromUser(isStartTime: true, ctx: context);
                            }),
                      ),
                      ...
                      Expanded(
                        child: TimeBox(
                          ...
                          onPressed: () {
                            FocusScope.of(context).unfocus();
                            todoProviderForMethods.getTimeFromUser(isStartTime: false, ctx: context);
                          },
                        ),
                      ),
                    ],
                  ...
                  DropDownBox(
                      ...
                      widget: DropdownButton(
                        isExpanded: true,
                        hint: Text('${todoProvider.selectedReminder} early'),
                        ...
                        items: todoProvider.reminderList.map<DropdownMenuItem<String>>((int value) {
                        ...
                        onChanged: (String? newValue) =>
                            todoProviderForMethods.onReminderChanged(newValue: newValue, context: context),
                        elevation: 5,
                  ...
                  DropDownBox(
                    ...
                    widget: DropdownButton(
                      hint: Text(todoProvider.selectedRepeat == '' ? "None" : todoProvider.selectedRepeat),
                      ...
                      iconSize: 32,
                      underline: Container(height: 0),
                      items: todoProvider.repeatList.map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(
                            value,
                      ...
                      onChanged: (String? newValue) =>
                          todoProviderForMethods.onRepeatChanged(newValue: newValue, context: context),
                      elevation: 5,
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ...
                      Button(
                          ...
                          onTap: () {
                            ...
                            todoProviderForMethods.validate(
                                title: _titleController.text, note: _noteController.text, context: context);
