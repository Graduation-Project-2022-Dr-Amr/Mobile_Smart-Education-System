...
class _CollegesState extends State<Colleges> {
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results =
          allcolleges.where((user) => user["title"].toLowerCase().contains(enteredKeyword.toLowerCase())).toList();
    }
                            ...
                            children: [
                              ListTile(
                                ...
                                contentPadding: EdgeInsets.only(
                                    left: SizeConfig.getProportionateScreenWidth(18),
                                      ...
                                      builder: (innerContext) {
                                        return AlertDialog(
                                          ...
                                          actions: [
                                            Padding(
                                              padding: EdgeInsets.symmetric(
                                                  vertical: SizeConfig.getProportionateScreenHeight(28),
                                                  ...
                                                  Form(
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        textInputAction: TextInputAction.done,
                                                        decoration: InputDecoration(
                                                          hintText: 'University code [8-digits]',
                                                          hintStyle: TextStyle(
                                                            fontSize: 16,
                                                            fontStyle: FontStyle.normal,
                                                            fontWeight: FontWeight.w500,
