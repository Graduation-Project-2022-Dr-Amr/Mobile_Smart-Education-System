    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Button(
                      color: purple,
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ChangeNotifierProvider<TodoProvider>(create: (_)=>TodoProvider(),child: AddTaskPage(),)));
                      },
          ...
          todoProvider.taskList.isEmpty?Stack(
            children: [
              AnimatedPositioned(
